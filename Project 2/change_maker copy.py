        ...
        if c[0].isdigit() == True and c[1].isdigit() == True:       # #checks if right and left values are numbers    
            ...
            if g % 5 == 0:  #checks if number is multiple of 5
                ...
                while True:
                    ...
                    if total1<0:
                        print("take your money: " + str(abs(float(total1)/100)))
        ...
        #############
            ...
            if g % 5 == 0:      #checks if number is multiple of 5
                ...
                while True:
                    ...
                    if total2<0:
                        print("take your money: " + str(abs(float(total2))/100))





                    print("Payment due: " + cent_value + " cents ")
    ...
    ############
            ...
            if float(k) % 5 == 0:       # checks if it is a multiple of 5
                ...
                while True:
                    ...
                    if total3<0:
                        print("take your money: " + str(abs(total3)))





                    print("Payment due: " + dollar_value + " dollars ")
